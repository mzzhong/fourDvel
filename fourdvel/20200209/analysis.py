...
######################
    ...
    def point_time_series(self):
        ...
        # Plot M2
        # Get M2 parameters
        quant_name = "M2_up_displacement_amplitude"
        M2_up_disp_amp = self.tide_vec_to_quantity(tide_vec = tide_vec, quant_name = quant_name,  point=point, state="est")
        print(M2_up_disp_amp)

        quant_name = "M2_up_displacement_phase_in_deg"
        M2_up_disp_phase = self.tide_vec_to_quantity(tide_vec = tide_vec, quant_name = quant_name,  point=point, state="est")
        print(M2_up_disp_phase)
 
        
        quant_name = "O1_up_displacement_amplitude"
        O1_up_disp_amp = self.tide_vec_to_quantity(tide_vec = tide_vec, quant_name = quant_name,  point=point, state="est")
        print(O1_up_disp_amp)
